...
sudo dnf makecache
sudo dnf install -y neofetch xclip vim tldr fuse python3 python3.11-venv npm zsh curl autojump fzf gpg p7zip-full nodejs eza
sudo npm install -g typescript
sudo dnf install libevent-dev libncurses5-dev libncursesw5-dev
